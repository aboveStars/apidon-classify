...
# Define a function for classification with a given model
def classify_image(model_func, image_tensor):
    ...
    return model_func.__name__, predictions

# Use ThreadPoolExecutor to run classification for multiple models concurrently
with concurrent.futures.ThreadPoolExecutor() as executor:
    futures = [executor.submit(classify_image, model_func, image_tensor) for model_func in model_list]
